...
//    tree3.traversals();
    ...
    LinkedBinaryTree tree4 = new LinkedBinaryTree();
...
//    tree4.traversals();
    ...
    System.out.println("tree4 count left leaf=" + tree4.countLeftLeaf());


    tree4.pruneSubtree(10);
    System.out.println("after prune sub tree=" + tree4.size());
